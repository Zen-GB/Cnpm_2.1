...
public class ChangePasswordDialog extends JDialog {
	...
	public ChangePasswordDialog() {
		...
		changepasswordbutton = new JButton("Đổi");
		...
		changepasswordbutton.setBackground(new Color(255, 178, 170));
		...
		oldshowbutton.addActionListener(e->
				{
					if(oldshowbutton.getText().equals("Hiện"))
					{
						oldpasswordfield.setEchoChar('\u0000');
						oldshowbutton.setText("Ẩn");
					}
					else if(oldshowbutton.getText().equals("Ẩn"))
					{
						oldpasswordfield.setEchoChar((Character)UIManager.get("PasswordField.echoChar"));
						oldshowbutton.setText("Hiện");
					}
				}
				);
		getContentPane().add(oldshowbutton);
		
		JButton newshowbutton = new JButton("Hiện");
		...
		newshowbutton.setBackground(new Color(255, 178, 170));
		newshowbutton.setBounds(445, 135, 70, 40);
		newshowbutton.setFocusable(false);
		newshowbutton.addActionListener(e->
					{
						if(newshowbutton.getText().equals("Hiện"))
						{
							newpasswordfield.setEchoChar('\u0000');
							newshowbutton.setText("Ẩn");
						}
						else if(newshowbutton.getText().equals("Hiện"))
						{
							newpasswordfield.setEchoChar((Character)UIManager.get("PasswordField.echoChar"));
							newshowbutton.setText("Hiện");
						}
					}
				);
		getContentPane().add(newshowbutton);
		
		JButton new2showbutton = new JButton("Hiện");
		...
		new2showbutton.setBackground(new Color(255, 178, 170));
		new2showbutton.setBounds(445, 197, 70, 40);
		new2showbutton.setFocusable(false);
		new2showbutton.addActionListener(e->
		{
			if(new2showbutton.getText().equals("Hiện"))
			{
				newpasswordfield2.setEchoChar('\u0000');
				new2showbutton.setText("Ẩn");
			}
			else if(new2showbutton.getText().equals("Ẩn"))
			{
