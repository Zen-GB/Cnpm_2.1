...
public class LoginPanel extends JPanel implements ActionListener
{
	...
	public LoginPanel(String loginprofile,ImageIcon imageicon,LoginPageFrame lpf) {
		...
		lblPassword.setBackground(new Color(255, 178, 170));
		...
		useridfield = new HintTextField("Nhap tai khoan");
		...
		lblEmailId.setBackground(new Color(255, 178, 170));
		...
		loginbutton.setBackground(new Color(255, 178, 170));
		loginbutton.setBounds(20, 355, 383, 44);
		loginbutton.setFocusable(false);
		loginbutton.setBorderPainted(false);
		add(loginbutton);
		
		JLabel lblStudentLogin = new JLabel(loginprofile);
		...
		passwordfield = new HintPasswordField("Mat khau");
		...
		showandhidebutton.setBounds(341, 272, 62, 44);
		  showandhidebutton.setBorder(new EmptyBorder(0, 0, 0, 0));
		    ...
		    {
		    	if(showandhidebutton.getText().equals("Hien"))
		    	{
		    		passwordfield.setEchoChar('\u0000');
		    		showandhidebutton.setText("An");
		    	}
		    	else
		    	{
		    		passwordfield.setEchoChar((Character)UIManager.get("PasswordField.echoChar"));
		    		showandhidebutton.setText("Hien");
		    	}
		    });
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		else if(loginprofile.equals("Giang vien"))
		{
			...
			if(result==true)
			{
				...
				if(!f.getCourceCode().equals("Khong tim thay"))
				{
				...
				{
					JOptionPane.showMessageDialog(null,"Tai khoan chua duoc kich hoat!","Loi dang nhap",JOptionPane.ERROR_MESSAGE);
				}
				
			}
		}
		else if(loginprofile.equals("Sinh vien"))
		{
