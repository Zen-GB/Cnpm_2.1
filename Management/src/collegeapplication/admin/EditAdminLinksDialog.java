...
public class EditAdminLinksDialog extends JDialog {
	...
	public EditAdminLinksDialog(Admin a,AdminMain am) {
		...
		JLabel lblNewLabel = new JLabel("Chỉnh sửa liên kết mạng xã hội");
		lblNewLabel.setOpaque(true);
		lblNewLabel.setBackground(new Color(255, 178, 170));
